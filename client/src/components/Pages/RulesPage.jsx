  ...
  return (
    <>
      ...
      >
        ...
        {user.id && <Button onClick={()=>{navigate("/play")}}>Play</Button>}
      </div>
      In the first part of the game you will be showing the railway map, with
      all stations and names as well as the lines connecting the different
      stations. You can always change the line you are travelling with at the
      interchange stations. Make sure to memorize this map! As soon as you press
      start, the 90s long planning phase will begin. You will be given a start-
      and end-station and your goal is to plan a route from that starting
      station to the end-station. But of course, there is a catch: You no longer
      see the lines on the map, you have to rely on your memory and choose the
